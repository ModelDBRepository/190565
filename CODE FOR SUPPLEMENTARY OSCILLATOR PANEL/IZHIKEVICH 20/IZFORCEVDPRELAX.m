...
Q =2*10^4; %Gain on the rank-k perturbation modified by RLS. 
Irh = 0.25*ff*(vt-vr)^2; 
...
%% van der pol 
 ...
 [t,y]= ode45(@(t,y)vanderpol(mu,MD,TC,t,y),0:0.001:Ts,[0.1;0.1]); %run once to get to steady state oscillation
 [t,y]= ode45(@(t,y)vanderpol(mu,MD,TC,t,y),0:0.001:Ts,y(end,:));
 tx = (1:1:nt)*dt/1000; 
...
%% eigenvaluesb before and after learning
plot(Z2,'r.'), hold on 
plot(Z,'k.') 
