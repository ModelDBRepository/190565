...
%% 
 T = 70; tmin = 5; tcrit = 55; nt = round(T/dt); tx = (1:1:nt)*dt;  xz = (sin(2*tx*pi*4).*sin(2*tx*pi*6) + randn(1,nt)*0.05)';  G = 50; Q = 2*10^4; %Scaling Weight for BPhi
...
Z2 = eig(OMEGA+E*BPhi');  %eigenvalued after learning 
figure(42)
plot(Z,'k.'), hold on 
plot(Z2,'r.')
xlabel('Re\lambda')
