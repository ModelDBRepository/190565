...
T = 15; imin = round(5/dt); icrit = round(10/dt); step = 50; nt = round(T/dt); Q = 10; G = 0.04;
...
%% Plot neurons pre- amd post- learning
figure(30)
for j = 1:1:5
...
title('Pre-Learning')
%%
Z = eig(OMEGA+E*BPhi');  %eigenvalues post learning 
Z2 = eig(OMEGA);  %eigenvalues pre learning
%% Plot eigenvalues 
figure(40)
plot(Z2,'r.'), hold on 
plot(Z,'k.') 
